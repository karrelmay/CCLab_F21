...
function setup() {
  ...
  imgButtonReset = loadImage("resetButton.PNG");
  imgCounter = loadImage("counter.PNG");
}
...
function draw() {
  ...
  // draw_hydro(width / 2, height / 2, 0, 1);

  // update and display the objects
  //this checks slime element for interaction during collision
...
function preload() {
  genshinFont = loadFont("GenshinFont.ttf");
}
